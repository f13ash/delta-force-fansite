    ...
    set1: {
        ...
        quests: {
            quest1: {
                title: "В самое пекло",
                warning: [],
                objectives: ["Эвакуируйтесь из любой обычной или сложной операции с 5 предметами / ед. снаряжения общей стоимостью более 12 500 ед. сплава Текник"],
            ...
            quest2: {
                title: "Зажечь пламя",
                warning: [],
                objectives: ["Во время любой обычной или сложной операции убейте 5 вражеских солдать из любого автомата"],
			...
			quest5: {
                title: "Дух битвы",
                warning: [],
                objectives: ["Во время любой обычной или сложной операции убейте 1 вражеского оперативника из любого автомата", "Во время люой обычной или сложной операции убейте 1 вражеского оперативника из любого  пистолета-пулемета", "Во врем любой обычной или сложной операции эвакуируйтесь, взяв с собой в общей сложности 6 жетонов оперативников"],
			...
			quest7: {
                ...
                warning: [],
                objectives: ["Во время обычной или сложной операции в Космогороде выполните 3 задачи", "Во время любой обычной или сложной операции в Космогороде убейте 6 врагов особого класса: щитоносцев, снайперов и т.д."],
    ...
    set2: {
        ...
        quests: {
            ...
            quest2: {
                ...
                warning: [""],
                objectives: ["Во время любой обычной или сложной операции убейте 3 вражеских оперативников"],
    ...
    set3: {
        ...
        quests: {
            quest1: {
                ...
                objectives: ["Во время любой обычной или сложной операции убейте любых 8 обычных солдат гвардии Ах-Сарах", "Во время любой обычной или сложной операции убейте любых 3 врагов особого класса гвардии Ах-Сарах: щитоносцы, снайперы, граники и т.д."],
    ...
    set4: {
        ...
        quests: {
            quest1: {
                ...
                supplyRewards: [],
                comments: "Используйте бинокль для разведки",
                level: 1,
                connectsTo: []
            }
        }
    ...
    Object.entries(currentQuests).forEach(([setId, setData]) => {
        if (setId.startsWith(setNumber)) {
            ...
            setElement.innerHTML = `
                ...
                <div class="season6-set-difficulty">${setData.difficulty}</div>
